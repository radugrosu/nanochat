...
def main(
    ...
    train_tasks = GSM8K(subset="main", split="train")
    val_tasks = GSM8K(subset="main", split="test")
    num_steps = (len(train_tasks) // examples_per_step) * num_epochs
    ...
    def get_batch():
        ...
        for example_idx in itertools.cycle(rank_indices):
            ...
            for sample_tokens in generated_token_sequences:
                ...
                reward = train_tasks.reward(conversation, generated_text)
    ...
    for step in range(num_steps):
        ...
        for example_step in range(examples_per_rank):
            ...
            assert len(inputs_all) % device_batch_size == 0
            num_passes = len(inputs_all) // device_batch_size
