...
def find_common_length(
    token_sequences: list[list[int]], direction: Literal["left", "right"] = "left"
) -> int:
...
def batch_sequences_mc(
    tokenizer: RustBPETokenizer, prompts: list[str]
...
def evaluate_example(
    ...
    if max_tokens := getattr(model, "max_seq_len", None):
    ...
    if task_type == "language_modeling":
        ...
        is_correct = cast(bool, is_correct)
